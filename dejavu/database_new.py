...
class Database(object):
    ...
    FIELD_FILE_SHA1 = 'file_sha1' #TODO not sure what it is
    FIELD_PERSON_ID = 'person_ID' #person ID (unique) - changed from SONG_ID
    FIELD_PAIR_ID = 'pair_ID' #pair ID (not unique) - changed from SONGNAME
    FIELD_OFFSET = 'offset'
    FIELD_HASH = 'hash' #type-binary10
